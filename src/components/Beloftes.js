...
export default function Beloftes() {
  return (
    <section className="container-fluid bg-[#262626] py-[50px] md:py-[100px]">
        <div className="container mx-auto px-4 xl:px-0">
            <div className="grid grid-cols-12 gap-4 space-y-8 mb-[50px] md:mb-[100px]">
                <div className="col-span-11 xl:col-span-8">
                    <p className="text-lg md:text-3xl font-medium leading-[1.5] text-white">Goede samenwerking geeft het beste beeld. Onze verbeelding begint namelijk bij jouw input. Dankzij onze 3 Beeldbeloftes werk je zoveel mogelijk mee aan het resultaat, zonder dat het je agenda opslokt.</p>
                </div>
            </div>
