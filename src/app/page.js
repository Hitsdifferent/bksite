      ...
      <section className="container mx-auto pt-[50px] md:pt-[100px] pb-[100px] md:pb-[250px] px-4 md:px-0">
        <div className="grid grid-cols-12 gap-4">
          ...
          <div className="col-span-12 md:col-span-4 md:col-start-9 grid content-between">
            ...
            <Link href="/services">
              <div className="font-medium uppercase text-sm md:text-md mt-16 xl:mt-0 group">
                <span className="px-[30px] py-[10px] text-white bg-[#262626] border-2 border-[#262626] transition duration-300 ease-in-out group-hover:text-black group-hover:bg-white group-hover:border-2">hallo@beeldkameraden.nl</span>
              </div>
            </Link>
          </div>
        </div>
