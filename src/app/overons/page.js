        ...
        <section className="container-fluid mx-auto bg-[#262626] py-[50px] xl:py-[100px] mt-[50px]">
            <div className="container mx-auto px-4 xl:px-0">
                ...
                <div className="grid grid-cols-12 gap-4 xl:gap-8">
                     <AuthorFetcher>
                    {(fetchedAuthors) => {
                    //zelfde check als bij services
                    if (authors !== fetchedAuthors) setAuthors(fetchedAuthors);
                    ...
                    return authors.length > 0 ? (                         
                        authors.map((authorItem, index) => (
                            ...
                            <div className="col-span-6 md:col-span-3" key={index} >
                                <AnimatedBlock>
                                <div className="relative bg-blue-600 h-[200px] md:h-[350px] xl:h-[500px] rounded-xl overflow-hidden">
        ...
        <section className="container-fluid mx-auto py-[50px] xl:py-[100px]">
            ...
            <div className="grid grid-cols-12 gap-4 text-black">               
                <div className="col-span-12 md:col-span-6">
                    <AnimatedBlock> 
                        <div className="relative bg-neutral-400 aspect-video rounded-2xl overflow-hidden">
                            <Image 
                            src="/images/Beeldkameraden_Portraits_26 mei 2025.jpg" 
